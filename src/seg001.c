...
// seg001:0584
void cutscene_1() {
	set_kashira_animations(0,3);
	fade_in_1();
	add_princess_text("have you heard, have you heard?", 30);
	proc_cutscene_frame(30);
	set_kashira_animations(2,-1);
	add_princess_text("i'm a pilgrim on a long journey.", 30);
	proc_cutscene_frame(30);
	add_princess_text("at the end, i'll find god.", 30);
	proc_cutscene_frame(30);
	set_kashira_animations(-1,4);
	add_princess_text("where are you going?", 30);
	proc_cutscene_frame(3);
	set_kashira_animations(-1,5);
	proc_cutscene_frame(27);
	add_princess_text("god's house is right here.", 30);
	proc_cutscene_frame(30);
	fade_out_1();
};
void cutscene_2() {
	set_kashira_animations(0,6);
	fade_in_1();
	add_princess_text("have you heard, have you heard?", 30);
	proc_cutscene_frame(30);
	set_kashira_animations(1,-1);
	proc_cutscene_frame(20);
	set_kashira_animations(0,-1);
	add_princess_text("be careful!", 30);
	proc_cutscene_frame(30);
	add_princess_text("these eggs were a gift from my boyfriend!", 30);
	proc_cutscene_frame(30);
	add_princess_text("if i break them, the love will spill out!", 30);
	proc_cutscene_frame(30);
	set_kashira_animations(1,-1);
	proc_cutscene_frame(30);
	fade_out_1();
...
void cutscene_3() {
	set_kashira_animations(0,0);
	fade_in_1();
	add_princess_text("have you heard, have you heard?", 30);
	proc_cutscene_frame(30);
	set_kashira_animations(1,0);
	add_princess_text("you have no self-awareness!", 30);
	proc_cutscene_frame(30);
	add_princess_text("why am i your friend?", 30);
	proc_cutscene_frame(30);
	set_kashira_animations(0,1);
	add_princess_text("because you're just like me.", 30);
	proc_cutscene_frame(20);
	set_kashira_animations(0,0);
	proc_cutscene_frame(10);
	set_kashira_animations(1,0);
	add_princess_text("oh, give me a break!", 30);
	proc_cutscene_frame(35);
	set_kashira_animations(-1,1);
	proc_cutscene_frame(30);
	fade_out_1();
};
void cutscene_4() {
	set_kashira_animations(7,0);
	fade_in_1();
	add_princess_text("have you heard, have you heard?", 30);
	proc_cutscene_frame(30);
	add_princess_text("aren't i beautiful?", 30);
	proc_cutscene_frame(30);
	set_kashira_animations(-1,1);
	add_princess_text("you'll be the belle of the ball!", 30);
	proc_cutscene_frame(30);
	set_kashira_animations(-1,0);
	...
	proc_cutscene_frame(30);
	set_kashira_animations(-1,1);
	add_princess_text("how shocking!", 30);
	proc_cutscene_frame(10);
	set_kashira_animations(-1,0);
	proc_cutscene_frame(20);
	add_princess_text("it wasn't fair.", 30);
	proc_cutscene_frame(30);
	add_princess_text("it was my reflection that was doing it.", 30);
	proc_cutscene_frame(30);
	set_kashira_animations(-1,1);
	add_princess_text("your reflection was moving without you?", 30);
	proc_cutscene_frame(20);
	set_kashira_animations(-1,0);
	proc_cutscene_frame(10);
	set_kashira_animations(8,-1);
	proc_cutscene_frame(30);
	fade_out_1();
}
void cutscene_5() {
	set_kashira_animations(9,10);
	fade_in_1();
	add_princess_text("have you heard, have you heard?", 30);
	proc_cutscene_frame(30);
	add_princess_text("enough!", 30);
	proc_cutscene_frame(30);
	add_princess_text("you'll be a zookeeper, full stop.", 30);
	proc_cutscene_frame(30);
	add_princess_text("like me,and my father before me.", 30);
	proc_cutscene_frame(30);
	add_princess_text("fine! then i'll be a better zookeeper than you!", 30);
	proc_cutscene_frame(30);
	set_kashira_animations(-1,11);
	proc_cutscene_frame(3);
	set_kashira_animations(-1,12);
	proc_cutscene_frame(3);
	add_princess_text("ow!", 30);
	proc_cutscene_frame(6);
	set_kashira_animations(-1,13);
	proc_cutscene_frame(5);
	set_kashira_animations(-1,14);
	proc_cutscene_frame(25);
	set_kashira_animations(15,-1);
	proc_cutscene_frame(4);
	set_kashira_animations(16,-1);
	proc_cutscene_frame(30);
	fade_out_1();
};
void cutscene_6() {
	set_kashira_animations(17,18);
	fade_in_1();
	add_princess_text("have you heard, have you heard?", 30);
	proc_cutscene_frame(30);
	add_princess_text("we're finally getting married!", 30);
	set_kashira_animations(19,-1);
	proc_cutscene_frame(20);
	set_kashira_animations(17,-1);
	proc_cutscene_frame(10);
	add_princess_text("it's so romantic!", 30);
	set_kashira_animations(-1,20);
	proc_cutscene_frame(30);
	add_princess_text("all our friends will be there!", 30);
	proc_cutscene_frame(20);
	set_kashira_animations(-1,18);
	proc_cutscene_frame(10);
	...
	set_kashira_animations(17,-1);
	proc_cutscene_frame(20);
	add_princess_text("... you know that's just a part i played, right?", 30);
	set_kashira_animations(-1,20);
	proc_cutscene_frame(35);
	set_kashira_animations(19,-1);
	proc_cutscene_frame(30);
