...
void cutscene_1(void);
void cutscene_2(void);
void cutscene_3(void);
void cutscene_4(void);
void cutscene_5(void);
void cutscene_6(void);
...
int get_modifier_infrontof_char(void);
